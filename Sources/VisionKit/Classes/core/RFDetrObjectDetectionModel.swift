//
//  VKDetrObjectDetectionModel.swift
//  VisionKit
//
...
public class VKDetrObjectDetectionModel: VKObjectDetectionModel {
    ...
    private func detectWithVNCoreML(pixelBuffer buffer: CVPixelBuffer, completion: @escaping (([VKPrediction]?, Error?) -> Void)) {
    ...
    /// Process DETR raw outputs into VKObjectDetectionPrediction objects
    private func processDETROutputs(boxes: MLMultiArray, scores: MLMultiArray, labels: MLMultiArray, imageWidth: Int, imageHeight: Int) throws -> [VKObjectDetectionPrediction] {
        var detections: [VKObjectDetectionPrediction] = []
        ...
        for i in 0..<numDetections {
            ...
            let detection = VKObjectDetectionPrediction(
                x: centerX,
                y: centerY,
                width: width,
                height: height,
