...
//Creates an instance of an ML model for computer vision
public class VKSDKModel: NSObject {
    ...
    public func detect(pixelBuffer: CVPixelBuffer, completion: @escaping (([VKSDKPrediction]?, Error?) -> Void)) {
        completion(nil, NSError(domain: "VKSDKModel", code: -1, userInfo: [NSLocalizedDescriptionKey: "Error loading model"]))
    }
 
    public func detect(pixelBuffer: CVPixelBuffer) async -> ([VKSDKPrediction]?, Error?) {
